...
// If you see "process.env" this meanse the value is in the "config.json" file.
...
const credentials = {
  ...
  redirect_uris: ["https://letscodemanh.github.io/MeetApp/"],
  javascript_origins: [
    "https://letscodemanh.github.io",
    "http://localhost:3000",
  ],
};
...
module.exports.getAccessToken = async (event) => {
  ...
  return new Promise((resolve, reject) => {
    // Exchange authorization code for access token with a "callback" after the exchange, The callback in this case is an arrow function with the results as parameters: "error" and "token"
